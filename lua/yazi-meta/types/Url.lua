...
--- @field join fun(self: self, url: yazi.Url):yazi.Url Joins with another Url or a string of url, returns a new Url
--- @field parent fun(self: self):yazi.Url? Returns parent directory Url if any, otherwise nil
--- @field starts_with fun(self: self, url: yazi.Url):boolean Whether the url starts with another Url or a string of url
--- @field ends_with fun(self: self, url: yazi.Url):boolean Whether the url ends with another Url or a string of url
--- @field strip_prefix fun(self: self, url):yazi.Url Strips the prefix of another Url or a string of url, returns a new Url
---
--- MetaMethods:
--- @metamethod __eq(another_url: yazi.Url)
